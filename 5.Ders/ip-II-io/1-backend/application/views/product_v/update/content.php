          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="<?php echo base_url("Product/update/$item->id") ?>">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="<?php echo base_url("Product") ?>" class="btn btn-default float-right">Vazgeç</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
