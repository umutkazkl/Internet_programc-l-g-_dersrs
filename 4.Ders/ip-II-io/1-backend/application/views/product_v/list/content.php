                      ...
                      <?php foreach ($items as $item) {  ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url("Product/delete/$item->id") ?>" class="btn btn-danger"> Sil </a>


                            <a href="<?php echo base_url("Product/update_form/$item->id"); ?>" class="btn btn-info">Güncelle</a>
                          </td>
                        </tr>
                      <?php } ?>
